...
import type { ApiClient, APIKey, IdPOAuthAccessToken, MachineToken } from '../../src/api';
import type { AuthenticatedMachineObject, AuthObject, InvalidTokenAuthObject, SignedInAuthObject, SignedOutAuthObject, UnauthenticatedMachineObject } from '../../src/tokens/authObjects';
import type { SessionTokenType, TokenType } from '../../src/tokens/tokenTypes';
import type { VerifyTokenOptions } from '../../src/tokens/verify';
/**
 * @interface
 */
...
type AuthOptions = PendingSessionOptions & {
